# Russell Lancaster Portfolio - TODO

## Website Development Tasks

- [x] Design modern portfolio layout with professional color scheme
- [x] Create hero section with professional summary
- [x] Build About section with detailed background
- [x] Create Experience section with timeline
- [x] Build Education section
- [x] Create Featured Projects showcase with 5 main projects
- [x] Build Certifications section focused on data science/analysis/engineering
- [x] Add Skills section with technical stack
